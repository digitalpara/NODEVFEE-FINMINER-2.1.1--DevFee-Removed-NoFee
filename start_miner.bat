...
chcp 437 >nul
rem Set title
title FiNMINER WatchDog Version %V% by DiGiTaLPaRa_SiMSEK_2018
...
echo ###############################################################################
echo.
echo   FiNMINERWatchDog Version %V%
echo.
...
echo 1. Run FiNMINER.
echo 2. Restart FiNMINER up to 5 times.
echo 3. Reboot the system.
echo.
echo Additional:
echo - AutoFix #385 issue of FiNMINER
echo - AutoFix #189 issue of FiNMINER
...
echo FiNMINERWatch Version %V% >> %FileOut%
...
echo ===============================================================================
echo %pISOdate%
echo FiNMINERWatchDogSMSK has run %loopnum% times.
echo ===============================================================================
echo.

rem ========== File Output ==========

echo %pISOdate% FiNMINERWatchDogSMSK has run %loopnum% times.>>%FileOut%
